...
import userThree from '../../images/user/user-default.png';
...
const Profile = () => {
  ...
  const [avatarPreview, setAvatarPreview] = useState<string>(''); // preview local
  const [avatarFile, setAvatarFile] = useState<File | null>(null); // arquivo real
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div
                    id="FileUpload"
                    className="relative mb-5.5 block w-full appearance-none rounded border border-dashed border-primary bg-gray py-4 px-4 dark:bg-meta-4 sm:py-7.5"
                  >
                    {/* INPUT INVISÍVEL */}
                    <input
                      type="file"
                      ...
                      onChange={(e) => {
                        ...
                        const previewUrl = URL.createObjectURL(file); // mostra preview local
