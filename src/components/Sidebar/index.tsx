...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const mostrarOthers = false;
  const mostrarTables = false;
  const mostrarForms = false;
    ...
    >
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <h3 className="mt-6 mb-1 ml-4 text-sm font-semibold text-bodydark2">
                USUÁRIO
              </h3>
      ...
      <div className="p-4">
        <button
          ...
          className="w-full flex items-center justify-start gap-2.5 rounded-sm py-2 px-4 font-medium text-red-600 hover:bg-graydark dark:hover:bg-meta-4"
        >
          <svg
            className="fill-current"
            width="18"
          ...
          >
            <path
              d="M16 17L21 12M21 12L16 7M21 12H9M13 3H5C4.46957 3 3.96086 3.21071 3.58579 3.58579C3.21071 3.96086 3 4.46957 3 5V19C3 19.5304 3.21071 20.0391 3.58579 20.4142C3.96086 20.7893 4.46957 21 5 21H13"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
